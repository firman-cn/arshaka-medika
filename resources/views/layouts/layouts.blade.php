    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item nav-category">
            <span class="nav-link">Pasien</span>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('tambahpasien')}}">
              <span class="menu-icon">
                <i class="mdi mdi-account-plus-outline"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('listdatapasien')}}">
              <span class="menu-icon">
          ...
          <li class="nav-item nav-category">
            <span class="nav-link">Pemeriksaan</span>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('pemeriksaan')}}">
              ...
              <span class="menu-title">Form Pemeriksaan</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('listpemeriksaan')}}">
              <span class="menu-icon">
                <i class="mdi mdi-view-list"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('tambahobat')}}">
              ...
              <span class="menu-title">Tambah Obat</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('listdataobat')}}">
              <span class="menu-icon">
                <i class="mdi mdi-account-plus-outline"></i>
              </span>
